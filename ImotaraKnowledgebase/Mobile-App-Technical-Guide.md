...
Imotara Mobile is the Expo / React Native client for Imotara. This build is **v1.3.2 (build 132)**. Mobile and web share one backend (`www.imotara.com` + Supabase project `rfsbvbqtiesswnplslln`). Repo: `github.com/soumenroys/imotara-mobile`. This guide is grounded in the actual source.
