    ...
    <table style="width:100%;border-collapse:collapse;font-size:9.5px;margin-bottom:14px;">
      ...
      <tbody>
        ...
        <tr style="background:var(--light);"><td style="padding:6px 10px;border-bottom:1px solid var(--border);color:var(--slate);font-weight:500;">Current version</td>
          <td style="padding:6px 10px;border-bottom:1px solid var(--border);text-align:center;color:var(--slate);">v1.4.0 (build 140)</td>
          <td style="padding:6px 10px;border-bottom:1px solid var(--border);text-align:center;color:var(--slate);">v1.4.0 (build 140)</td>
          <td style="padding:6px 10px;border-bottom:1px solid var(--border);text-align:center;color:var(--slate);">v1.4.0</td></tr>
        <tr><td style="padding:6px 10px;border-bottom:1px solid var(--border);color:var(--slate);font-weight:500;">Minimum OS</td>
          <td style="padding:6px 10px;border-bottom:1px solid var(--border);text-align:center;color:var(--slate);">iOS 16.0+</td>
          <td style="padding:6px 10px;border-bottom:1px solid var(--border);text-align:center;color:var(--slate);">Android 7.0+</td>
