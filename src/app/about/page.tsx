...
export default function AboutPage() {
  return (
    <div className="space-y-6 text-sm text-zinc-100">
      {/* Hero / Intro */}
      <section className="imotara-glass-card rounded-2xl px-4 py-5 sm:px-6 sm:py-6">
        ...
        <p className="mt-3 leading-6 text-zinc-300">
          ...
          There are no ads, no engagement tricks, and no hidden agendas. Just
          presence, memory, and care. Your data stays yours — always.
        </p>
      </section>
      ...
      <section className="grid gap-4 lg:grid-cols-2">
        ...
        <div className="imotara-glass-soft rounded-2xl px-4 py-4 sm:px-5 sm:py-5">
          <h2 className="text-sm font-semibold text-zinc-50">Principles</h2>
          ...
          <ul className="mt-3 list-disc space-y-2 pl-5 text-xs leading-6 text-zinc-300 sm:text-sm">
            ...
            <li>
              Long-term emotional memory with clear, transparent controls for
              you to delete, export, or move anywhere.
            </li>
            <li>
              Local-first architecture: everything stays on your device unless
        ...
        {/* Roadmap */}
        <div className="imotara-glass-soft rounded-2xl px-4 py-4 sm:px-5 sm:py-5">
          <h2 className="text-sm font-semibold text-zinc-50">Roadmap</h2>
