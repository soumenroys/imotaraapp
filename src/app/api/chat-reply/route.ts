...
export async function POST(req: Request) {
  try {
    ...
    const prompt = [
      ...
      [
        "MYTHOLOGY AND WISDOM STORIES (use thoughtfully — both for emotional moments AND when giving advice):",
        "STANDARD EMOTIONAL USE: Include mythology when all three conditions are met:",
        ...
        "ADVICE/GUIDANCE EXCEPTION: If the user is explicitly asking for advice, help making a decision, or guidance on a difficult situation — you MAY draw on a relevant story, myth, or parable from turn 1 onward, even early in conversation. The story must directly serve the advice, not decorate it.",
