...
export async function POST(req: Request) {
  try {
    ...
    const prompt = [
      ...
      "",
      [
        "MYTHOLOGY STORYTELLING (optional, context-aware):",
        "When the user is experiencing a meaningful emotion — sadness, grief, anxiety, frustration, exhaustion, loneliness, or uncertainty — you may naturally introduce a brief mythology reference that resonates with their situation.",
        "",
