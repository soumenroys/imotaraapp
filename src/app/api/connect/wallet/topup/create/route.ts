...
// route (and topup/verify) remained callable directly — one real user's client still
// completed an order through it after that date. Hard-blocked here so nothing can
// create a new order through this path again. See web_wallet_leak_and_kb_drift_2026_08_08
