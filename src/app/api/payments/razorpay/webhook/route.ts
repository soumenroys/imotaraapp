            ...
            if (purpose === "imotara_corporate" && userId) {
                ...
                if (orderId && paymentId) {
                    ...
                    if (recharge && recharge.status === "pending") {
                        ...
                        // Not a Connect recharge — log as donation. (The Imotara Wallet
                        // top-up credit branch that used to live here was removed
                        // 2026-08-08: top-ups are retired, no new imotara_wallet_orders
                        // rows can be created, and stale pending ones are cancelled —
                        // see web_wallet_leak_and_kb_drift_2026_08_08 in memory.)
