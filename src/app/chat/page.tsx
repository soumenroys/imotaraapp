...
function Bubble({
  ...
  const bubbleClass = [
    ...
    isUser
      ? "bg-gradient-to-br from-indigo-500/80 via-sky-500/80 to-emerald-400/80 text-white shadow-[0_18px_40px_rgba(15,23,42,0.85)] hover:scale-[1.01] hover:brightness-110"
      : assistantClass,
    ...assistantHover,
    highlighted
