          ...
          <div className="animate-fade-in space-y-3 rounded-2xl border border-white/10 bg-white/5 px-4 py-4 backdrop-blur-md">
            ...
            <div className="flex items-center justify-between gap-2">
              ...
              <button
                ...
                onClick={save}
                disabled={saving}
                className="rounded-full bg-gradient-to-r from-indigo-500 to-sky-400 px-5 py-2 text-sm font-medium text-black shadow transition hover:brightness-110 disabled:opacity-50"
              >
