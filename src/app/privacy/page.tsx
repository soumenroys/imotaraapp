    ...
    <main className="mx-auto w-full max-w-4xl px-4 py-16 text-zinc-50 sm:px-6">
      ...
      <section className="mt-8 imotara-glass-soft rounded-2xl p-6">
        ...
        <ul className="mt-3 list-disc space-y-2 pl-6 text-sm text-zinc-300">
          <li>
            Consent-first: features that need cloud use clear, explicit
            opt-ins.
          </li>
          <li>Minimalism by default: collect only what’s essential.</li>
          <li>Transparency: plain language, no dark patterns.</li>
          <li>
            Control: export and delete options wherever technically feasible.
          </li>
      ...
      <section className="mt-6 imotara-glass-soft rounded-2xl p-6">
        ...
        <ul className="mt-3 list-disc space-y-2 pl-6 text-sm text-zinc-300">
          ...
          <li>
            <strong>Optional cloud features</strong>: only when you opt in; we’ll
            explain the why and where.
          </li>
        </ul>
      </section>
      ...
      <section className="mt-6 imotara-glass-soft rounded-2xl p-6">
        ...
        <p className="mt-3 text-sm leading-7 text-zinc-300">
          We don’t sell personal data. We may use vetted processors (e.g., cloud
          infrastructure, analytics) bound by contracts to process data on our
          behalf and under our instructions. We may also disclose information if
