...
const FEATURES: Record<string, Feature[]> = {
  ...
  chat: [
    ...
    },
    {
      ...
      short: "Each reply shows whether it came from the cloud or the on-device local engine.",
      long: "A small badge on each message shows 'Synced to cloud' (cloud, full quality) or 'Local' (on-device engine, works offline). When your daily cloud quota is reached or you're offline, Imotara automatically switches to local mode — you keep chatting without interruption.",
      steps: [
        "Look at the small label below each companion reply.",
        "'Synced to cloud' = the reply came from the cloud.",
