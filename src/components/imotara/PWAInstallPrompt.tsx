...
export default function PWAInstallPrompt() {
  ...
  return (
    <div
      ...
      className="fixed bottom-20 left-4 z-50 w-[calc(100%-2rem)] max-w-[280px] rounded-2xl border border-white/10 bg-black/85 px-4 py-3 shadow-xl backdrop-blur-xl animate-slide-up sm:bottom-6 sm:left-auto sm:w-auto"
    >
