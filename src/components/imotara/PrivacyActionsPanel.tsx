    ...
    return (
        <div className="mt-4 rounded-2xl border border-zinc-800/80 bg-zinc-900/40 p-4 shadow-inner">
            ...
            <p className="mt-2 text-sm text-zinc-300">
                These controls apply to the data stored locally in this browser for the
                current Imotara preview. They do not affect any future fully cloud-hosted
                accounts you may create.
            </p>
            ...
            <div className="mt-4 flex flex-wrap gap-3">
                <button
                    ...
                    disabled={isBusy}
                    className="inline-flex items-center gap-2 rounded-full border border-emerald-400/60 px-4 py-2 text-sm font-medium text-emerald-100 shadow-sm transition hover:bg-emerald-500/10 disabled:cursor-not-allowed disabled:opacity-60"
                >
                    <Download className="h-4 w-4" />
                    {exportState === "running" ? "Preparing export…" : "Export data (JSON)"}
                </button>
                ...
                <button
                    ...
                    disabled={isBusy}
                    className="inline-flex items-center gap-2 rounded-full border border-rose-500/80 px-4 py-2 text-sm font-medium text-rose-100/90 shadow-sm transition hover:bg-rose-600/10 disabled:cursor-not-allowed disabled:opacity-60"
                >
                    <Trash2 className="h-4 w-4" />
                    {deleteState === "running" ? "Deleting…" : "Delete from this device"}
                </button>
            </div>
