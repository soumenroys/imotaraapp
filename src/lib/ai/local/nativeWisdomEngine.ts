...
// ─── Hebrew (עברית) ───────────────────────────────────────────────────────────
const WISDOM_HE: WisdomBank = {
    sad: [
        "הכאב הוא ראיה שמשהו היה חשוב לך — לא חולשה, אלא עומק.",
        "גם הלילה הכבד ביותר מסתיים — הבוקר תמיד חוזר.",
        "מי שבוכה לא נשבר — הוא פשוט מרשה לעצמו להרגיש בצורה אמיתית.",
        "צער שמדברים עליו כבר קצת יותר קל מצער שסוחבים לבד.",
    ],
    anxious: [
        "הדמיון מגיע לעתיד מוקדם מדי — רוב מה שאתה חושש ממנו עדיין לא קרה.",
        "צעד אחד קטן הוא יותר ממה שנדמה לך — תתחיל שם.",
        "מה שיש עכשיו, ברגע הזה — זה מה שצריך להחזיק.",
        "החרדה שקרה — הנשימה תמיד שם, ומחכה לך.",
    ],
    angry: [
        "הכעס הוא אות — כדאי לשמוע אותו לפני שמגיבים בגללו.",
        "מה שכואב לך גילה מה חשוב לך — הכעס הוא פנים של אכפתיות.",
        "לא כל קרב שווה להילחם בו — חלק מהחוזק הוא לדעת מתי לשחרר.",
        "הכעס מדבר אמת על הכאב, אך לא תמיד מראה את הדרך הנכונה.",
    ],
    tired: [
        "מי שנושא הרבה — מגיע לו גם לנוח הרבה.",
        "עייפות אמיתית היא סימן שנתת מעצמך — לא שנכשלת.",
        "לפעמים הדבר האמיץ ביותר הוא פשוט לעצור ולנשום.",
        "מנוחה אינה עצלות — היא הדרך שחוזרים ממנה חזקים יותר.",
    ],
};

// ─── Japanese (日本語) ────────────────────────────────────────────────────────
const WISDOM_JA: WisdomBank = {
    sad: [
        "悲しみは、大切なものがあった証です。それは弱さではありません。",
        "今夜どれほど重くても、朝はまた来ます。",
        "涙は言葉にならない気持ちのための場所です。",
        "一人で抱えるより、声に出すほうが、少し軽くなります。",
    ],
    anxious: [
        "心はまだ起きていないことを先に旅してしまいます。今この瞬間に戻ってください。",
        "一歩だけ。階段全体を一度に上る必要はありません。",
        "今あることで、今は十分です。",
        "不安が来たとき、呼吸はいつもそこにあります。",
    ],
    angry: [
        "怒りは何かが大切だったことを教えてくれます。まず聞いてから行動しましょう。",
        "傷ついたから怒っている。その痛みは本物です。",
        "すべての戦いに応じる必要はありません。手放すことも強さです。",
        "怒りは真実を語りますが、道を示すとは限りません。",
    ],
    tired: [
        "疲れは、長い間頑張ってきた証です。",
        "休むことは弱さではありません。また立ち上がるための準備です。",
        "毎日続けること、それだけで十分です。",
        "本当に疲れているとき、立ち止まることが最も賢い選択です。",
    ],
};
