...
const ROMAN_HINTS: Record<string, RegExp> = {
  ...
  mr: /\b(mi|mala|maaz|majha|majhi|tu|tula|tuza|tujhi|aapan|aapla|aapli|tila|tichya|ti|ahe|aahe|hote|hoti|hotam|asato|asate|karto|karte|kartoy|nahiye|nahi|ani|mhanje|jevha|tevha|karan|jar|kuthun|kuthla|kasa|kashi|kaay|kon|koni|konacha|nakko|aavad|aavadt|aavadta|chan|sundar|vaait|khaup|khoop|thoda|jaast|parat|aata|aadhi|nantar|vegla|baro|theek|ho|ja|ye|de|bagh|saman|aai|baba|dada|tai|mama|kaka|bhai|bhaau|vahini|maitrin)\b/i,
  gu: /\b(hun|mane|mara|mari|tame|tamne|tamara|tamari|ae|tene|tena|teni|aa|aanu|aani|aavy|gayo|gai|gayu|che|chhe|hato|hati|hatu|karum|karo|kare|karsho|nahi|nai|ane|jem|eno|ena|eni|kai|shu|kem|kyan|kyare|keni|kaun|koi|kuch|koik|badhu|ghanu|thodu|vadhare|sarum|kharab|thik|chokku|ho|na|aa|ja|de|le|juo|suno|kaho|samjo|dil|man|jindagi|gharne|bhaibandh|mitra|kaka|kaki|mama|mami|ben|bhai|ba|bapa)\b/i,
...
async function callImotaraAPI(
  ...
  if (platform === "mobile") {
    ...
    body = {
      ...
      ...(config.responseStyle ? { responseStyle: config.responseStyle } : {}),
