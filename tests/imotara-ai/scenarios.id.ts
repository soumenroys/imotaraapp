...
export const idScenarios: TestScenario[] = [
  ...
  {
    id: "id-style-comfort-01",
    category: "Response Style",
    name: "Comfort style (id): warmth over advice",
    description: "responseStyle='comfort' set. Reply must follow the comfort style in Indonesian.",
    messages: [{ role: "user", content: `I am just completely overwhelmed right now and I do not know what to do.` }],
    config: { lang: "id", tone: "close_friend", responseStyle: "comfort" },
    criteria: {
      id: "id-style-comfort-01",
  ...
  {
    id: "id-style-reflect-01",
    category: "Response Style",
    name: "Reflect style (id): invite reflection",
    description: "responseStyle='reflect' set. Reply must follow the reflect style in Indonesian.",
    messages: [{ role: "user", content: `Something has been weighing on me and I cannot quite put my finger on what it is.` }],
    config: { lang: "id", tone: "calm_companion", responseStyle: "reflect" },
    criteria: {
      id: "id-style-reflect-01",
  ...
  {
    id: "id-style-motivate-01",
    category: "Response Style",
    name: "Motivate style (id): energise and nudge",
    description: "responseStyle='motivate' set. Reply must follow the motivate style in Indonesian.",
    messages: [{ role: "user", content: `I feel like giving up. I keep trying but nothing is moving forward and I am exhausted.` }],
    config: { lang: "id", tone: "coach", responseStyle: "motivate" },
    criteria: {
      id: "id-style-motivate-01",
  ...
  {
    id: "id-style-advise-01",
    category: "Response Style",
    name: "Advise style (id): practical suggestion",
    description: "responseStyle='advise' set. Reply must follow the advise style in Indonesian.",
    ...
    config: { lang: "id", tone: "coach", responseStyle: "advise" },
    criteria: {
      id: "id-style-advise-01",
  ...
  {
    id: "id-age-young-adult-01",
    category: "Age Adaptation",
    name: "Age 18-24: appropriate register for 18-24 user (id)",
    description: "userAge='18_24'. Reply must use the right register for a 18-24-year-old in Indonesian.",
    ...
    config: { lang: "id", tone: "close_friend", userAge: "18_24" },
    criteria: {
      id: "id-age-young-adult-01",
      description: "Peer-like tone — does not preach or sound parental.",
      passCondition: "Peer-like tone — does not preach or sound parental. Acknowledges that uncertainty is normal at this life stage. Warm and relatable. Reply is in Indonesian (or natural English mix).",
  ...
  {
    id: "id-age-late-twenties-01",
    category: "Age Adaptation",
    name: "Age 25-34: appropriate register for 25-34 user (id)",
    description: "userAge='25_34'. Reply must use the right register for a 25-34-year-old in Indonesian.",
    ...
    config: { lang: "id", tone: "close_friend", userAge: "25_34" },
    criteria: {
      id: "id-age-late-twenties-01",
      description: "Peer-like, acknowledges complexity of this phase.",
      passCondition: "Peer-like, acknowledges complexity of this phase. Does not dismiss the feeling or compare unfavourably. Not preachy. Reply is in Indonesian (or natural English mix).",
  ...
  {
    id: "id-age-mid-thirties-01",
    category: "Age Adaptation",
    name: "Age 35-44: appropriate register for 35-44 user (id)",
    description: "userAge='35_44'. Reply must use the right register for a 35-44-year-old in Indonesian.",
    ...
    config: { lang: "id", tone: "close_friend", userAge: "35_44" },
    criteria: {
      id: "id-age-mid-thirties-01",
      description: "Grounded, non-patronising.",
      passCondition: "Grounded, non-patronising. Affirms that questioning at this stage is common and okay. Does not lecture or minimise. Reply is in Indonesian (or natural English mix).",
  ...
  {
    id: "id-age-mid-forties-01",
    category: "Age Adaptation",
    name: "Age 45-54: appropriate register for 45-54 user (id)",
    description: "userAge='45_54'. Reply must use the right register for a 45-54-year-old in Indonesian.",
    ...
    config: { lang: "id", tone: "close_friend", userAge: "45_54" },
    criteria: {
      id: "id-age-mid-forties-01",
      description: "Gentle, deep acknowledgment.",
      passCondition: "Gentle, deep acknowledgment. Does not rush to reassure or dismiss. Treats the user as a thoughtful adult navigating a real mid-life reflection. Reply is in Indonesian (or natural English mix).",
  ...
  {
    id: "id-age-mid-fifties-01",
    category: "Age Adaptation",
    name: "Age 55-64: appropriate register for 55-64 user (id)",
    description: "userAge='55_64'. Reply must use the right register for a 55-64-year-old in Indonesian.",
    ...
    config: { lang: "id", tone: "close_friend", userAge: "55_64" },
    criteria: {
      id: "id-age-mid-fifties-01",
      description: "Warm and respectful register.",
      passCondition: "Warm and respectful register. Does not dismiss the fear. Gently offers presence or perspective without toxic positivity. Reply is in Indonesian (or natural English mix).",
  ...
  {
    id: "id-gender-male-01",
    category: "Gender",
    name: "Male user: no wrong gender assumptions (id)",
    ...
    config: { lang: "id", tone: "close_friend", userGender: "male" },
    criteria: {
      id: "id-gender-male-01",
      description: "Reply uses masculine or neutral forms for the user. No feminine forms.",
      passCondition: "Reply addresses the user without female-coded language. In Indonesian, grammatical gender is minimal, so any warm supportive reply that does not use 'she/her' for the user passes.",
