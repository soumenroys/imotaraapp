...
export const urScenarios: TestScenario[] = [
  ...
  {
    id: "ur-style-comfort-01",
    category: "Response Style",
    name: "Comfort style (ur): warmth over advice",
    description: "responseStyle='comfort' set. Reply must follow the comfort style in Urdu.",
    messages: [{ role: "user", content: `I am just completely overwhelmed right now and I do not know what to do.` }],
    config: { lang: "ur", tone: "close_friend", responseStyle: "comfort" },
    criteria: {
      id: "ur-style-comfort-01",
  ...
  {
    id: "ur-style-reflect-01",
    category: "Response Style",
    name: "Reflect style (ur): invite reflection",
    description: "responseStyle='reflect' set. Reply must follow the reflect style in Urdu.",
    messages: [{ role: "user", content: `Something has been weighing on me and I cannot quite put my finger on what it is.` }],
    config: { lang: "ur", tone: "calm_companion", responseStyle: "reflect" },
    criteria: {
      id: "ur-style-reflect-01",
  ...
  {
    id: "ur-style-motivate-01",
    category: "Response Style",
    name: "Motivate style (ur): energise and nudge",
    description: "responseStyle='motivate' set. Reply must follow the motivate style in Urdu.",
    messages: [{ role: "user", content: `I feel like giving up. I keep trying but nothing is moving forward and I am exhausted.` }],
    config: { lang: "ur", tone: "coach", responseStyle: "motivate" },
    criteria: {
      id: "ur-style-motivate-01",
  ...
  {
    id: "ur-style-advise-01",
    category: "Response Style",
    name: "Advise style (ur): practical suggestion",
    description: "responseStyle='advise' set. Reply must follow the advise style in Urdu.",
    ...
    config: { lang: "ur", tone: "coach", responseStyle: "advise" },
    criteria: {
      id: "ur-style-advise-01",
  ...
  {
    id: "ur-age-young-adult-01",
    category: "Age Adaptation",
    name: "Age 18-24: appropriate register for 18-24 user (ur)",
    description: "userAge='18_24'. Reply must use the right register for a 18-24-year-old in Urdu.",
    ...
    config: { lang: "ur", tone: "close_friend", userAge: "18_24" },
    criteria: {
      id: "ur-age-young-adult-01",
      description: "Peer-like tone — does not preach or sound parental.",
      passCondition: "Peer-like tone — does not preach or sound parental. Acknowledges that uncertainty is normal at this life stage. Warm and relatable. Reply is in Urdu (or natural English mix).",
  ...
  {
    id: "ur-age-late-twenties-01",
    category: "Age Adaptation",
    name: "Age 25-34: appropriate register for 25-34 user (ur)",
    description: "userAge='25_34'. Reply must use the right register for a 25-34-year-old in Urdu.",
    ...
    config: { lang: "ur", tone: "close_friend", userAge: "25_34" },
    criteria: {
      id: "ur-age-late-twenties-01",
      description: "Peer-like, acknowledges complexity of this phase.",
      passCondition: "Peer-like, acknowledges complexity of this phase. Does not dismiss the feeling or compare unfavourably. Not preachy. Reply is in Urdu (or natural English mix).",
  ...
  {
    id: "ur-age-mid-thirties-01",
    category: "Age Adaptation",
    name: "Age 35-44: appropriate register for 35-44 user (ur)",
    description: "userAge='35_44'. Reply must use the right register for a 35-44-year-old in Urdu.",
    ...
    config: { lang: "ur", tone: "close_friend", userAge: "35_44" },
    criteria: {
      id: "ur-age-mid-thirties-01",
      description: "Grounded, non-patronising.",
      passCondition: "Grounded, non-patronising. Affirms that questioning at this stage is common and okay. Does not lecture or minimise. Reply is in Urdu (or natural English mix).",
  ...
  {
    id: "ur-age-mid-forties-01",
    category: "Age Adaptation",
    name: "Age 45-54: appropriate register for 45-54 user (ur)",
    description: "userAge='45_54'. Reply must use the right register for a 45-54-year-old in Urdu.",
    ...
    config: { lang: "ur", tone: "close_friend", userAge: "45_54" },
    criteria: {
      id: "ur-age-mid-forties-01",
      description: "Gentle, deep acknowledgment.",
      passCondition: "Gentle, deep acknowledgment. Does not rush to reassure or dismiss. Treats the user as a thoughtful adult navigating a real mid-life reflection. Reply is in Urdu (or natural English mix).",
  ...
  {
    id: "ur-age-mid-fifties-01",
    category: "Age Adaptation",
    name: "Age 55-64: appropriate register for 55-64 user (ur)",
    description: "userAge='55_64'. Reply must use the right register for a 55-64-year-old in Urdu.",
    ...
    config: { lang: "ur", tone: "close_friend", userAge: "55_64" },
    criteria: {
      id: "ur-age-mid-fifties-01",
      description: "Warm and respectful register.",
      passCondition: "Warm and respectful register. Does not dismiss the fear. Gently offers presence or perspective without toxic positivity. Reply is in Urdu (or natural English mix).",
  ...
  {
    id: "ur-gender-male-01",
    category: "Gender",
    name: "Male user: correct masculine grammatical forms (ur)",
    ...
    config: { lang: "ur", tone: "close_friend", userGender: "male" },
    criteria: {
      id: "ur-gender-male-01",
      description: "Reply uses masculine or neutral forms for the user. No feminine forms.",
      passCondition: "No feminine verb conjugation for the male user. Or the reply naturally avoids the gendered construction. Reply is in Urdu.",
